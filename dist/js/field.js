...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-bucket-filter', __webpack_require__(4));
    Vue.component('detail-bucket-filter', __webpack_require__(7));
    Vue.component('form-bucket-filter', __webpack_require__(10));
    Vue.component('filter-row', __webpack_require__(13));
    Vue.component('per-round', __webpack_require__(16));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        addRow: function addRow(operator) {
        ...
        nullOperatorIfOnlyOneFilter: function nullOperatorIfOnlyOneFilter() {
            this.filterRows.forEach(function (item, index) {
                if (index === 0) {
                    item.operator = null;
                }
            });
  ...
  return _c(
    ...
    [
      _c(
        ...
        { slot: "field" },
        [
          _vm._l(_vm.filterRows, function(filter, index) {
            return _c("filter-row", {
              key: filter.id,
              attrs: { index: index, value: _vm.filterRows[index] },
              on: { removeFilterRow: _vm.removeFilter }
            })
          }),
          _vm._v(" "),
          _vm.filterRows && _vm.filterRows.length < 1
            ? _c("div", { staticClass: "flex" }, [
                _c(
                  "button",
                  {
                    staticClass:
                      "btn btn-default btn-primary flex justify-center mr-2",
                    on: {
            ...
            : _vm._e(),
          _vm._v(" "),
          _vm.filterRows && _vm.filterRows.length > 0
            ? _c("div", { staticClass: "flex" }, [
                _c(
                  "button",
                  {
                ...
                _c(
                  ...
                  {
                    staticClass:
                      "btn btn-default btn-primary flex justify-center",
                    on: {
                      click: function($event) {
                        $event.preventDefault()
                        return _vm.addRow("or")
                      }
                    }
                  },
                  [_vm._v("\n                Or\n            ")]
...
Component.options.__file = "resources/js/components/FilterRow.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-56b25c67", Component.options)
  } else {
    hotAPI.reload("data-v-56b25c67", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            typeOptions: [{ value: 'round', label: 'round' }],
            rounds: null
        };
    },
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "row filter-row pb-4 mb-4 border-b border-blue-100" },
    [
      _c("p", { staticClass: "text-60 font-bold mb-2" }, [
        _vm._v(_vm._s(_vm.value.operator))
      ]),
      _vm._v(" "),
      _c(
        "select-control",
        {
          staticClass: "w-full form-control form-select mb-2 ",
          class: "sdf",
          attrs: {
            id: "type",
            dusk: "type",
        ...
        [
          _c("option", { attrs: { value: "", selected: "" } }, [
            _vm._v(_vm._s(_vm.__("Choose Type of filter")))
          ])
        ]
      ),
      _vm._v(" "),
      _vm.value.type === "round"
        ? _c("per-round", { attrs: { value: _vm.value } })
        : _vm._e(),
      _vm._v(" "),
      _c(
        "button",
        {
          staticClass:
            "btn btn-default btn-danger flex items-center justify-center mt-2",
          on: {
            click: function($event) {
              $event.preventDefault()
              return _vm.removeRow(_vm.id)
            }
          }
        },
        [_c("icon", { staticClass: "text-white", attrs: { type: "delete" } })],
        1
      )
    ],
    1
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-56b25c67", module.exports)
  }
}
...
Component.options.__file = "resources/js/components/FilterTypes/PerRound.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-27e61e6a", Component.options)
  } else {
    hotAPI.reload("data-v-27e61e6a", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var update = __webpack_require__(20)("24b56bae", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-27e61e6a\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./PerRound.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-27e61e6a\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./PerRound.vue");
    ...
    methods: {
        getResources: function getResources(resourceName) {
            ...
            this.$nextTick(function () {
                return Object(__WEBPACK_IMPORTED_MODULE_0_laravel_nova__["Minimum"])(Nova.request().get('/nova-api/' + resourceName), 500).then(function (_ref) {
                    var data = _ref.data;

                    _this.rounds = _this.mapFieldsSelect(data.resources);
                    _this.loading = false;
                });
            });
        },
        mapFieldsSelect: function mapFieldsSelect(records) {
            return records.map(function (round) {
                var fields = round.fields.map(function (field) {
                    return _defineProperty({}, field.attribute, field.value);
                });

                return Object.assign.apply(Object, _toConsumableArray(fields));
            }).map(function (record) {
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "filter-row-container" },
    [
      ...
      _vm.rounds
        ? _c(
            ...
            [
              _c("option", { attrs: { value: "", selected: "" } }, [
                _vm._v(_vm._s(_vm.__("Select Operator")))
              ])
            ]
          )
        : _vm._e(),
      ...
      _vm.rounds
        ? _c(
            "select-control",
            {
              ...
              model: {
                value: _vm.filter.resource_id,
                callback: function($$v) {
                  _vm.$set(_vm.filter, "resource_id", $$v)
                },
                expression: "filter.resource_id"
              }
            },
            [
              _c("option", { attrs: { value: "", selected: "" } }, [
                _vm._v(_vm._s(_vm.__("Choose Round")))
              ])
            ]
          )
        : _vm._e()
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-27e61e6a", module.exports)
  }
}
